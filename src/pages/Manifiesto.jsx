...
function Manifiesto() {
  ...
  return (
    <Wrapper>
      <Button onClick={languageChange}>{language === 'english' ? 'español' : 'english'}</Button>
      {language === 'español' ?
        <>
          <Hero />
